...
function ju_misc_customizer_section( $wp_customize ) {
  ...
  $wp_customize->add_control(new WP_Customize_Control(
    ...
    array(
      'label'      => __( 'Show Sopping Cart Button in Header', 'udemy' ),
      'section'    => 'ju_misc_section',
  ...
  $wp_customize->add_control( new WP_Customize_Control(
    ...
    array(
      'label'       =>  __( 'Show Footer Copyright Text', 'udemy'),
      'section'     =>  'ju_misc_section',
  ...
  $wp_customize->add_control( new WP_Customize_Control(
    $wp_customize,
    'ju_footer_privacey_page_input',
    array(
      'label'       =>  __( 'Show Footer Privacy Policy Page', 'udemy' ),
      'section'     =>  'ju_misc_section',
